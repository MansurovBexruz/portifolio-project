    ...
    <>
      ...
      <div className="mx-[80px] mt-[50px] flex flex-col gap-[20px]">
        ...
        <div className="flex flex-col gap-[20px]">
          <p>Add Image</p>
          <div
            className="flex h-[250px] items-center justify-center gap-[20px] rounded-[12px] bg-[#f5f5f5]"
            style={{
              backgroundImage: `
      repeating-linear-gradient(to right, #9ca3af 0 16px, transparent 16px 32px),
      repeating-linear-gradient(to right, #9ca3af 0 16px, transparent 16px 32px),
      repeating-linear-gradient(to bottom, #9ca3af 0 16px, transparent 16px 32px),
      repeating-linear-gradient(to bottom, #9ca3af 0 16px, transparent 16px 32px)
    `,
              backgroundPosition: `
      top left,
