...
export function Category() {
  ...
  return (
    <div>
      <Navbar />
      <div className="mx-[80px] mt-[45px] flex w-[1400px] items-center justify-between space-y-[15px] rounded-[12px] bg-gray-100 p-[5px]">
        <div className="relative top-[8px] ml-[10px] flex gap-[20px]">
